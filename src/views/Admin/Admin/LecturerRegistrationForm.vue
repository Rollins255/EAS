<template>
    <nav-bar></nav-bar>
    <Toast/>
    <div class="w-screen flex items-center align-middle md:pt-10 overflow-auto">
        <form class="sm:w-3/4 w-[90%] mx-auto bg-slate-200 rounded-md" @submit.prevent="onSubmit">
            <div class="flex justify-center pt-5" @click="router.push('/')">
                <i class="pi pi-chevron-left pr-5"> </i>
                <i class="pi pi-home"> H O M E</i>
            </div>
            <div class="my-5">
            ...
            <div class="grid sm:grid-cols-2 grid-cols-1">
                ...
                <FloatLabel variant="on" class="sm:w-1/2 mx-auto">
                    <InputMask id="staffNo_label" mask="CU****" class="w-full my-5" required v-model="user.staffNo" autocomplete="off" />
            ...
            <div class="flex justify-center md:w-4/5 pb-5  mx-auto">
                <Button v-if="!isSubmitting" type="submit" class=" md:w-1/4 mx-auto font-bold">R E G I S T E R</Button>
